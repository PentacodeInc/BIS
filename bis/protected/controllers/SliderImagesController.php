...
class SliderImagesController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',  // allow all users to perform 'index' and 'view' actions
				...
				'users'=>array(implode(',', Access::getAllUserHasAccess('Maintain Slideshow'))),
			),
	...
	{
		$dataProvider=new CActiveDataProvider('SliderImages');
	 ...
	 * @param SliderImages $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='slider-images-form')
		{
