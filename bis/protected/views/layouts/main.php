	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
                ...
                array('label'=>'Photo Gallery', 'url'=>'https://www.facebook.com/pages/Barangay730zone79/515313718511386?sk=photos_stream&tab=photos_albums','visible'=>!Yii::app()->user->isGuest,'linkOptions'=>array('target'=>'blank')),
                array('label'=>'Downloadble Files', 'url'=>array('/site/page', 'view'=>'download'),'visible'=>!Yii::app()->user->isGuest),
